...
//        p.getDrawCanvas().drawText(str, (float)mid_x, (float) mid_y  - ((p.paint.descent() + p.paint.ascent()) / 2.0f), p.paint);
//
...
//        p.getDrawCanvas().drawText(str, (float)(drawB.x+drawB.w/2), (float)(drawB.y+drawB.h/2) - ((p.paint.descent() + p.paint.ascent()) / 2.0f), p.paint);    }
//
